...
VEHICLE_DEFAULT_STATE = [
    ...
    Hitpoints(1600, VehicleType.Swordfish),
    Hitpoints(400, VehicleType.Manta),
    Hitpoints(1200, VehicleType.Petrel),
...
INVENTORY_INDEX_MASS = {
    InventoryIndex.Ammo30mm.value: 1,
    InventoryIndex.Seal.value: 10000,
    InventoryIndex.Walrus.value: 15000,
    InventoryIndex.Bear.value: 20000,
    InventoryIndex.Albatross.value: 20000,
    InventoryIndex.Manta.value: 25000,
    InventoryIndex.Razorbill.value: 15000,
    InventoryIndex.Petrel.value: 20000,
    8: 20000, # barge
    InventoryIndex.Turret30mm.value: 500,
    InventoryIndex.AircraftChaingun.value: 500,
    InventoryIndex.RocketPod.value: 500,
    InventoryIndex.TurretCIWS.value: 6000,
    InventoryIndex.TurretIRMissile.value: 4000,
    InventoryIndex.BombLight.value: 250,
    InventoryIndex.BombMedium.value: 500,
    InventoryIndex.BombHeavy.value: 1000,
    InventoryIndex.MissilesIR.value: 500,
    InventoryIndex.MissilesLaser.value: 500,
    InventoryIndex.MissilesAir.value: 500,
    InventoryIndex.ActuatedCamera.value: 200,
    ...
    InventoryIndex.CruiseMissile.value: 2000,
    InventoryIndex.Rocket.value: 120,
    InventoryIndex.Flares.value: 10,
    InventoryIndex.Ammo20mm.value: 1,
    InventoryIndex.Ammo100mm.value: 18,
    InventoryIndex.Ammo120mm.value: 20,
    InventoryIndex.Ammo160mm.value: 43,
    InventoryIndex.Fuel.value: 100,
    InventoryIndex.Torpedo.value: 2000,
    ...
    InventoryIndex.AmmoSonicPulse.value: 10,
    InventoryIndex.AmmoSmoke.value: 10,
    InventoryIndex.Turret40mm.value: 1000,
    InventoryIndex.Ammo40mm.value: 1,
    InventoryIndex.HeavyCannon.value: 3000,
    InventoryIndex.VirusModules.value: 2000,
    51: 75000, #fish
    52: 75000,
    53: 75000,
    54: 75000,
